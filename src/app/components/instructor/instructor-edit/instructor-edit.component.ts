...
import { instructorEdit, instructorEditEducation, instructorEditExperience, instructorEditCourses, instructorEditReviews, instructorEditOverview, instructorEditContactDetails } from 'src/app/models/model';
